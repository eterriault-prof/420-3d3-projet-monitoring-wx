...
class App(wx.Frame):
    def __init__(self):
        ...
        self.label_cpu = wx.StaticText(panel, label="0%")
        font = self.label_cpu.GetFont()
        font.SetPointSize(24)
        font.MakeBold()
        self.label_cpu.SetFont(font)
        self.barre_cpu = wx.Gauge(panel, range=100, size=(300, 20))
        ...
        self.label_ram = wx.StaticText(panel, label="0%")
        font2 = self.label_ram.GetFont()
        font2.SetPointSize(24)
        font2.MakeBold()
        self.label_ram.SetFont(font2)
        self.barre_ram = wx.Gauge(panel, range=100, size=(300, 20))
        ...
        self.label_disque = wx.StaticText(panel, label="0%")
        font3 = self.label_disque.GetFont()
        font3.SetPointSize(24)
        font3.MakeBold()
        self.label_disque.SetFont(font3)
        self.barre_disque = wx.Gauge(panel, range=100, size=(300, 20))
